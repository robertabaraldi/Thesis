...
def baseline_run():
    ...
    n_array = 980 - t[first_peak] #compute time needed to arrive to 1000ms after end of AP
    t_array = np.array([i+1 for i in range(int(t[first_peak]),980)])
...
def ind_excel():
    ...
    return ind_1, ind_2, ind_3, ind_4, ind_5, ind_ctrl1, ind_ctrl2, ind_ctrl3, ind_ctrl4, ind_ctrl5
...
def err_excel():
    ...
    return err_1, err_2, err_3, err_4, err_5, err_ctrl1, err_ctrl2, err_ctrl3, err_ctrl4, err_ctrl5
...
def stim(ind):
    ...
    proto.schedule(0.045, 2510, 480, 1000, 1)
