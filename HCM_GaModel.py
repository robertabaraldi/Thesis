...
def get_feature_errors(ind):
    """
    Compares the simulation data for an individual to the baseline Kernik values. The returned error value is a sum of the differences between the individual and baseline values.
...
def plot_generation(inds,
    ...
    axs[1].plot(t, v, 'k', label='Original Kernik')
...
#%%
def start_ga(pop_size=80, max_generations=40):
    feature_targets = {'dvdt_max': [10, 60, 150],
                       'apa': [90, 110, 120],
                       'apd90': [200, 420, 600],
                       'mdp': [-80, -74, -58]
                       }
