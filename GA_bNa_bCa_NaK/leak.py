...
#mod['ikr']['g_scale'].set_rhs(0.7)
mod['iks']['g_scale'].set_rhs(0.2)
#mod['ical']['g_scale'].set_rhs(3)
#mod['ik1']['g_scale'].set_rhs(6.3)
#mod['ina']['g_scale'].set_rhs(2.9)
#mod['ito']['g_scale'].set_rhs(0.2)
#mod['ifunny']['g_scale'].set_rhs(0.13)
