...
sns.swarmplot(df_hcm, palette=sns.color_palette(['red','red','red','red','red','red','red','red','red','red','red']))
sns.swarmplot(df_ctrl, palette=sns.color_palette(['blue','blue','blue','blue','blue','blue','blue','blue','blue','blue','blue']))
